...
const VoiceRSS={speech:function(e){this._validate(e),this._request(e)},
...
function test(joke){
    VoiceRSS.speech({
        key: 'd57356bfe96c4118833e19f42a802d87',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    ...
    try{
        ...
        {
           joke = `${data.setup} ..... ${data.delivery}.....hahahaha`;
        }
        else{
            joke= `${data.joke}.....hahahaha`;
        };
        test(joke);
        //Disable button
        toggleButton();
